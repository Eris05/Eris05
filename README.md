...
<p align="center">
  🔐 MSc Cybersecurity student &nbsp;•&nbsp; ☁️ Cloud & DevOps enthusiast &nbsp;•&nbsp; 🎯 HackTheBox active
</p>
...
Hi, I'm **Eliana** — a Cybersecurity graduate student passionate about the intersection of **offensive security**, **DevOps automation**, and **cloud infrastructure**.

- 🎓 BSc in Computer Engineering @ Università della Calabria
- 🔒 MSc in Cybersecurity @ Università della Calabria *(graduating 2026)*
- 🏭 Trained with **NTT Data** on Agile, BDD, CI/CD and Azure DevOps
- 🎯 Active on **HackTheBox** — web exploitation, privilege escalation, network attacks
- ☁️ Built and deployed a full-stack platform on **AWS EC2** with Docker
- 🤖 Integrated **HuggingFace AI models** in production applications
